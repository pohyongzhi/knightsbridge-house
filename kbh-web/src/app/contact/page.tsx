        ...
        <section className = "bg-gray-50 py-16 relative">
            ...
            <div className = "mt-12 flex flex-col md:flex-row justify-center gap-16 px-4">
                <div className = "bg-white shadow-lg rounded-[12px] p-8 text-center w-full max-w-xl">
                    ...
                    <h3 className = "text-xl font-semibold text-gray-900 mb-2"> Our Contact Information </h3>
                    <p className = "text-gray-600 mb-4">
                        Reach out to us via our email or LINE chat!
                    </p>
                    <p className = "text-gray-800 font-medium mb-2">
                        Line: <a href = "https://line.me/R/ti/p/@444zvfzq?ts=12311529&oat_content=url" target = "_blank" rel = "noopener noreferrer" className = "text-blue-500 underline"> Chat with us on LINE </a>
                    </p>
                    <p className = "text-gray-800 font-medium">
                        Email Address: <a href = "mailto:admissions@kbh.co.th" className = "text-blue-500 underline"> admissions@kbh.co.th </a>
                    </p>
                </div>
                <div className = "bg-white shadow-lg rounded-[12px] p-8 text-center w-full max-w-xl">
                    <div className = "flex justify-center items-center mb-4">
