          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex flex-col flex-1">
              ...
              <p className="mt-4 text-white">
                Knightsbridge House, an international school from Singapore,
                opens in Nonthaburi, Bangkok in May 2025. We deliver quality
                education at affordable fees, fostering academic excellence
                while developing students' critical thinking, creativity, and
                character.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 p-10 gap-10 bg-brand rounded-3xl">
            <Card className="hover:scale-105 transition-all duration-100 ">
              <CardHeader className="flex flex-col text-center items-center">
                ...
                <CardDescription>
                  We foster student success through simple, effective education
            ...
            <Card className="hover:scale-105 transition-all duration-100">
              <CardHeader className="flex flex-col text-center items-center">
                ...
                <CardDescription>
                  We deliver Cambridge Primary and Lower Secondary education,
                  with Mandarin, Thai, and Singapore Math streams. Our globally
                  recognized program will expand to IGCSE and A-Levels.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="hover:scale-105 transition-all duration-100">
              <CardHeader className="flex flex-col text-center items-center">
                ...
                <CardDescription>
                  At KBH, we nurture each child's unique potential through
                  dedicated teachers and personalized care, fostering happy,
                  confident learners.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="hover:scale-105 transition-all duration-100">
              <CardHeader className="flex flex-col text-center items-center">
                ...
                <CardDescription>
                  Beyond academics, students enjoy diverse activities including
                  sports, arts, and performing arts in our spacious green
                  campus.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="hover:scale-105 transition-all duration-100">
              <CardHeader className="flex flex-col text-center items-center">
                ...
                <CardDescription>
                  We deliver quality international education at competitive
                  rates through efficient operations and smart resource
                  management, without compromising on teaching excellence or
                  facilities.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="hover:scale-105 transition-all duration-100">
              <CardHeader className="flex flex-col text-center items-center">
                ...
                <CardDescription>
                  {' '}
                  Our campus combines academic and recreational facilities, from
                  modern classrooms and labs to sports amenities including a
                  pool and multi-purpose court.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
