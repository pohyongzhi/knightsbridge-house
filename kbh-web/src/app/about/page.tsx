        ...
        <main>
            <section className="w-full bg-brand">
                <div className="max-w-screen-xl mx-auto px-8 sm:px-10 lg:px-12 py-20">
                    <div id="our-aim" className="flex justify-center items-center gap-5 text-white">
            ...
            <section className="max-w-screen-xl mx-auto px-8 sm:px-10 lg:px-12 py-20 flex flex-col sm:flex-row gap-8 items-center">
                <div className="grid">
                    <h2 className = "text-4xl font-semibold text-brand-secondary mb-4"> Founder's Message </h2>
            ...
            <section id="story" className="max-w-screen-xl mx-auto px-8 sm:px-10 lg:px-12 py-20 flex flex-col sm:flex-row gap-8 items-center">
